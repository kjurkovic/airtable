...
import (
	...
	"github.com/kjurkovic/airtable/service/auth/routes"
	"github.com/kjurkovic/airtable/service/auth/scheduler"
...
func (app *App) Initialize() {
	...
	go func() {
		logger.Info("Auth service listening on port %d", config.Server.Port)
	...
	scheduler.StartCleanScheduler(logger)
